    ...
    <dl id="cart_items">
      ...
      <dd class="lists" ng-repeat="cart_item in cart.items">
        <dl>
          ...
          <dd class="sz_s tl">{[cart_item.variation_name]}</dd>
      ...
      <!-- <dd class="lists shipping">
        <dl>
          <dd class="sz_m tr">{[I18n.store.cart.shippingFee]}(<?php echo Config::get('constants.item.currency'); ?>)</dd>
          <dd class="sz_s tr">{[cart.shipping_fee | number:0]}</dd>
        </dl>
      </dd> -->
      <dd class="lists total">
        <dl>
          <dd class="sz_m tr">{[I18n.store.cart.subtotal]}(<?php echo Config::get('constants.item.currency'); ?>)</dd>
