...
<div class="wrapper account">
    <div class="heading_box clearfix">
        <h2 class="heading fl_l">配送先情報</h2>
    ...
    <form class="form_basic">
        <dl class="cols">
            ...
            <dd>
                <ul>
                    <li>Họ</li>
                    <li>
                        <input class="sz_sm ng-pristine ng-invalid ng-invalid-required" type="text" name="last_name" ng-model="data.last_name" required="">
                    </li>
                    <li>Tên</li>
                    <li>
                        <input class="sz_sm ng-pristine ng-invalid ng-invalid-required" type="text" name="first_name" ng-model="data.first_name" required="">
                    </li>
                </ul>
        ...
        <dl class="cols">
            <dt>Mã bưu chính</dt>
            <dd>
                <input class="sz_s ng-pristine ng-invalid ng-invalid-required" type="text" name="zip" ng-model="data.zip" stores-zip-code="" required="">
                <span style="font-size:12px; margin-left:20px;">※Địa chỉ sẽ tự động nhập</span>
                <p class="error" ng-show="form.zip.$invalid &amp;&amp; (form.zip.$dirty || temp.clicked)" style="display: none;">郵便番号を入力してください</p>
            </dd>
        </dl>
        <dl class="cols">
            <dt>Quận</dt>
